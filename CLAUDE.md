...
| 指令 | 用途 |
| --- | --- |
| `npm run v3-bench -- --workers=8 --repeats=150` | **v3 權威評估**：v3 對 v2 的 1v1 勝率＋80% 門檻（平行化、CRN、平手算 0.5）。`--map=classic --v2=aggressor` 為快速單圖調參迴圈 |
