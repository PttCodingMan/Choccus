...
export const PIRATE_PROFILE: MapProfile = Object.freeze({
  ...
  // POINT 2 option C: OFF on pirate. A/B (v5-screen, v7:zoner vs v4:zoner) was
  // consistently NEGATIVE here (−5.6% @w50, −7.3% @w20): pirate already has the
  // strongest SOFT center pull (shrinkSurvivalWeight 6, its tuned mirror-breaker),
  // so a hard center-priority over-centralizes and breaks the tuned endgame.
