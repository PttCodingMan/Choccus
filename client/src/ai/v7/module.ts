/**
 * v7 adapter implementing the shared AiVersionModule contract (see ../index.ts).
 ...
 *
 * v7 is the FROZEN BT yardstick roster (see version.ts) — registered like any
 * other version so the benches can build `v7:<archetype>` agents, but never the
 * live default (mapChampions.ts pins the champion to v6).
 */
...
export const v7Module: AiVersionModule = {
  version: AI_VERSION,
